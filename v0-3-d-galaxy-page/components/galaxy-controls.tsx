      ...
      <CardContent className="space-y-4">
        ...
        <div className="border-t border-gray-600 pt-4 space-y-4">
          <div className="flex items-center justify-between">
            <Label className="text-white text-xs">Auto Rotate</Label>
            <Button
              size="sm"
          ...
          <div className="flex items-center justify-between">
            <Label className="text-white text-xs">Constellations</Label>
            <Button
              size="sm"
          ...
          <div className="flex items-center justify-between">
            <Label className="text-white text-xs">Star Labels</Label>
            <Button
              size="sm"
            ...
            >
              {showStarLabels ? "ON" : "OFF"}
            </Button>
          </div>

          <div className="space-y-2">
            <Label className="text-white text-xs">Quality: {qualityMode.toUpperCase()}</Label>
